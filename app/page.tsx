    ...
    <div className="max-w-4xl space-y-20 py-8">
      ...
      <section className="space-y-6">
        ...
        <div className="flex gap-4">
          <Link href="/projects" className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-4 py-2 rounded-md font-medium hover:bg-primary/90 transition">
            View Projects <ArrowRight className="size-4" />
          </Link>
          <Link href="/api-playground" className="inline-flex items-center gap-2 border px-4 py-2 rounded-md font-medium hover:bg-muted transition">
            Explore APIs
          </Link>
        </div>
      </section>
